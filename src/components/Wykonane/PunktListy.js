            ...
            <div className="wrapperLista">
                <div className="punktyListy1">
                    <div className="punktListy">
                        <MDBIcon icon="times-circle" onClick={this.toggle(14)} />
                        <MDBModal isOpen={this.state.modal14} toggle={this.toggle(14)} centered>
                            <MDBModalHeader toggle={this.toggle(14)}>Czy chcesz usunąć zlecenie z dnia {dataZlecenia}. <br />   Spowoduje to jego trwałe i nieodwracalne usunięcie</MDBModalHeader>
                            <MDBModalFooter>
                                <MDBBtn size="sm" outline onClick={this.toggle(14)}>Wróć</MDBBtn>
                                <MDBBtn size="sm" outline onClick={() => this.props.removeZadanie(id)}>Tak usuń</MDBBtn>
                            </MDBModalFooter>
                        </MDBModal>
                    </div>
                </div>
